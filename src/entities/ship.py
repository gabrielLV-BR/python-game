...
class Ship():
	...
	def __init__(self, pos: vec2):
		for i in range(7):
			self._explosion_gif.append(pygame.image.load(f"res/images/explosao/{i+1}.gif"))
		self._explosion_gif.append(pygame.image.load("res/images/explosao/8.png"))
	...
	def desenha(self, tela):
		...
		imagem_transformada = pygame.transform.rotozoom(self.imagem, -(self.angulo + 90), self.tamanho)	
